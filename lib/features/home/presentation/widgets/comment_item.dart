    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(padding: const EdgeInsets.only(left: 50), child: Text(comment.content)),
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            IconButton(icon: const Icon(Icons.thumb_up_alt_outlined, size: 18), onPressed: onLike),
